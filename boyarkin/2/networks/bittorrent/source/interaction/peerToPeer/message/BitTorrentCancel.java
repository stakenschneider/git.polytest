...
/**
 * BitTorrent 'cancel' message (message type 0x8).
 *
 * [length = 13 [4 bytes]]
 ...
 */
public class BitTorrentCancel extends BitTorrentMessage {
    /** Static message size of the 'cancel' message. */
    ...
    /** Message type value. */
    public static @NotNull final int DEFAULT_MESSAGE_TYPE = 0x8;
    ...
    /**
     * Offset from beginning of the cancelled piece.
     */
    private @NotNull final int mBegin;

    /**
     * Length of the cancelled piece.
     */
    private @NotNull final int mSize;

    /**
     * Creates new BitTorrentCancel object.
     * @param pieceId - Identifier of the cancelled piece.
     * @param begin - Offset from beginning of the cancelled piece.
     * @param size - Length of the cancelled piece.
     */
    public BitTorrentCancel(@NotNull final int pieceId, @NotNull final int begin, @NotNull final int size) {
    ...
    protected void initializeBytes() {
        ...
        // Set identifier of the cancelled piece.
        ...
        // Set offset from beginning of the cancelled piece.
        ...
        // Set length of the cancelled piece.
    ...
    /**
     * Parses 'cancel' message from byte array (with zero offset from the array beginning).
     ...
     * @return Returns new BitTorrentCancel object or null, if impossible to parse this object.
     * @throws IllegalArgumentException If length <= 0.
     */
    public static @Nullable BitTorrentCancel parse(@NotNull final byte[] bytes, @NotNull final int length) throws IllegalArgumentException {
        return parse(bytes, 0, length);
    }

    /**
     * Parses 'cancel' message from byte array.
     * @see BitTorrentMessage#parseAll(byte[], int)
     * @param bytes - Byte array for parsing.
     * @param length - Length of bytes into array to parse.
     * @return Returns new BitTorrentCancel object or null, if impossible to parse this object.
     ...
     */
    public static @Nullable BitTorrentCancel parse(@NotNull final byte[] bytes, @NotNull int offset, @NotNull final int length) throws IllegalArgumentException {
        if(offset >= length)
        ...
        // Try to parse identifier of the cancelled piece.
        int pieceId = 0;
        ...
        // Try to parse offset from beginning of the cancelled piece.
        int begin = 0;
