...
/**
 * BitTorrent 'choke' message (message type 0x0).
 *
 * [length = 1 [4 bytes]]
 ...
 */
public class BitTorrentChoke extends BitTorrentMessage {
    /** Static message size of the 'choke' message. */
    ...
    /** Message type value. */
    public static @NotNull final int DEFAULT_MESSAGE_TYPE = 0x0;

    /**
     * Creates new BitTorrentChoke object.
     */
    public BitTorrentChoke() {
    ...
    /**
     * Parses 'choke' message from byte array (with zero offset from the array beginning).
     ...
     * @return Returns new BitTorrentChoke object or null, if impossible to parse this object.
     * @throws IllegalArgumentException If length <= 0.
     */
    public static @Nullable BitTorrentChoke parse(@NotNull final byte[] bytes, @NotNull final int length) throws IllegalArgumentException {
        return parse(bytes, 0, length);
    }

    /**
     * Parses 'choke' message from byte array.
     * @see BitTorrentMessage#parseAll(byte[], int)
     * @param bytes - Byte array for parsing.
     * @param length - Length of bytes into array to parse.
     * @return Returns new BitTorrentChoke object or null, if impossible to parse this object.
     ...
     */
    public static @Nullable BitTorrentChoke parse(@NotNull final byte[] bytes, @NotNull int offset, @NotNull final int length) throws IllegalArgumentException {
        if(offset >= length)
