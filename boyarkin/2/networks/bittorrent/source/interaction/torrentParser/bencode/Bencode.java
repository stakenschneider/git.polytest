...
public class Bencode {
    ...
    static public BencodeObject parseBencode(PushbackInputStream in) throws IOException {
        ...
        switch (first) {
            ...
            default:
                throw new IOException("no interaction.torrentParser.bencode: illecal char: "+ ((char)first));
        }
    }
    ...
    static private BencodeObject parseBencodeInt(PushbackInputStream in) throws IOException {
        ...
        return new BencodeLong(parseBencodeReadInt(in));
    }
     ...
     * @throws java.io.IOException
     */
    static private long parseBencodeReadInt(PushbackInputStream in) throws IOException {
        long result = 0;
    ...
    static private BencodeObject parseBencodeString(PushbackInputStream in) throws IOException {
        int len = (int)parseBencodeReadInt(in);
    ...
    /**
     * Parse an interaction.torrentParser.bencode list
     * @param in the input stream
     * @return the Vector
     * @throws java.io.IOException
     */
    ...
    /**
     * Parse an interaction.torrentParser.bencode map
     * @param in the input stream
     * @return the HashMap
     * @throws java.io.IOException
     */
    ...
    static private void parseBencodeExpect(PushbackInputStream in, int b) throws IOException {
        int bIn = in.read();
        if (b != bIn) {
            throw new IOException("no interaction.torrentParser.bencode: illecal char: "+ ((char)bIn)+" ("+bIn+") expected: "+((char)b));
        }
    }
}