 ...
 */
public class BencodeString implements BencodeObject, Comparable<BencodeString> {
    private byte[] bytes;
    ...
    @Override
    public int compareTo(BencodeString string) {
        final String left = new String(bytes);
        final String right = new String(string.bytes);
