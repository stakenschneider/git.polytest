...
VALUES (1, 5, 3, 120, '01-10-2011', '09-25-2010', 1);
INSERT INTO CONSIGNMENT (ID_CONSIGNMENT,  ID_DRAG, ID_PROVIDER, CONSIGNMENT_DRAG_COUNT, CONSIGNMENT_ARRIVAL_DATE, CONSIGNMENT_MANUFACTURE_DATE, ID_DRUGSTORE)
VALUES (2, 2, 5, 1000, '02-13-2011', '02-11-2011', 1);
INSERT INTO CONSIGNMENT (ID_CONSIGNMENT,  ID_DRAG, ID_PROVIDER, CONSIGNMENT_DRAG_COUNT, CONSIGNMENT_ARRIVAL_DATE, CONSIGNMENT_MANUFACTURE_DATE, ID_DRUGSTORE)
VALUES (3, 7, 4, 300, '01-14-2011', '01-10-2011', 4);
INSERT INTO CONSIGNMENT (ID_CONSIGNMENT,  ID_DRAG, ID_PROVIDER, CONSIGNMENT_DRAG_COUNT, CONSIGNMENT_ARRIVAL_DATE, CONSIGNMENT_MANUFACTURE_DATE, ID_DRUGSTORE)
VALUES (4, 1, 2, 300, '02-15-2011', '02-01-2011', 3);
INSERT INTO CONSIGNMENT (ID_CONSIGNMENT,  ID_DRAG, ID_PROVIDER, CONSIGNMENT_DRAG_COUNT, CONSIGNMENT_ARRIVAL_DATE, CONSIGNMENT_MANUFACTURE_DATE, ID_DRUGSTORE)
VALUES (5, 3, 1, 600, '01-10-2011', '11-11-2010', 3);
INSERT INTO CONSIGNMENT (ID_CONSIGNMENT,  ID_DRAG, ID_PROVIDER, CONSIGNMENT_DRAG_COUNT, CONSIGNMENT_ARRIVAL_DATE, CONSIGNMENT_MANUFACTURE_DATE, ID_DRUGSTORE)
VALUES (6, 4, 1, 200, '01-20-2011', '12-20-2010', 2);
INSERT INTO CONSIGNMENT (ID_CONSIGNMENT,  ID_DRAG, ID_PROVIDER, CONSIGNMENT_DRAG_COUNT, CONSIGNMENT_ARRIVAL_DATE, CONSIGNMENT_MANUFACTURE_DATE, ID_DRUGSTORE)
VALUES (7, 5, 5, 100, '01-24-2011', '01-21-2011', 2);
INSERT INTO CONSIGNMENT (ID_CONSIGNMENT,  ID_DRAG, ID_PROVIDER, CONSIGNMENT_DRAG_COUNT, CONSIGNMENT_ARRIVAL_DATE, CONSIGNMENT_MANUFACTURE_DATE, ID_DRUGSTORE)
...
INSERT INTO REQUEST_FROM_DRUGSTORE (ID_REQUEST_FROM_DRUGSTORE,  ID_REQUEST, ID_DRUGSTORE, DRUG_PREVIOUS_COST, DRUG_COUNT)
VALUES (5, 7, 3, 35.0, 10);
INSERT INTO REQUEST_FROM_DRUGSTORE (ID_REQUEST_FROM_DRUGSTORE,  ID_REQUEST, ID_DRUGSTORE, DRUG_PREVIOUS_COST, DRUG_COUNT)
VALUES (6, 8, 4, 10.0, 40);    
