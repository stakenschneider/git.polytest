...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../max10_qsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is max10_qsys
SOPC_NAME := max10_qsys
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10000070
SOPC_SYSID_FLAG += --sidp=0x10000070
ELF_PATCH_FLAG  += --sidp 0x10000070

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1435901586
SOPC_SYSID_FLAG += --timestamp=1435901586
ELF_PATCH_FLAG  += --timestamp 1435901586
